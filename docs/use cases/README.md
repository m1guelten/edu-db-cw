...
:Обирає редактора;
:Надсилає запит на видалення редактора;
...
:Приймає або не приймає зміни розмітки даних;
:Відправляє системі запит на зміну розмітки даних;

|Система|
:Отримує запит на зміну розмітки даних;
...
:Адміністратор приймає або не приймає зміни розмітки даних;
|Система|
:Адміністратор відправляє системі запит на зміну розмітки даних
...
:Видаляє редактора;
:Надсилає редактору повідомлення про його видалення;

|Редактор|
:Отримує повідомлення про позбавлення прав редагування файлу;
